...
// Inspired blog http://informationandvisualization.de/blog/box-plot
d3.box = function() {
  var width = 1, height = 1, duration = 0, domain = null, value = Number, whiskers = boxWhiskers, quartiles = boxQuartiles, tickFormat = null;
  // For each small multiple…
  function box(g) {
    // g is the array of data passed in from before
    g.each(function(d, i) {
      // d is the actual dataset
      // i is the iteration #
      ...
      box.enter().append("rect")
          ...
          .style("fill", function(d) {return "#aec7e8"})
        .transition()
          .duration(duration)
      ...
      // Create Labels for Box
      /*var box_label = g.selectAll("rect.box").data([1]).enter().append("text");
      box_label.attr("x", function(d) { 0 })
                 .attr("y", function(d) { -1911.861520998865 })
